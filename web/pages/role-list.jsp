...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
									...
									<c:forEach items="${roleList}" var="role">
										<tr id="role${role.id}">
											...
											<td class="text-center">
												...
												<a onclick="deleteRoleById(${role.id})" class="btn bg-olive btn-xs">删除角色</a>
												<a href="${pageContext.request.contextPath}/role/findRoleByIdAllPermission.do?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		function deleteRoleById(roleId) {
			...
			if(confirm(msg)==true)
			{
				let target = $("#role"+roleId);
				$.post({
					url:"${pageContext.request.contextPath}/role/deleteById.do",
					data:{
						roleId:roleId
					},
