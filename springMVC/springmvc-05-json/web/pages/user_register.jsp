		...
		$(function () {
			...
			$("#registerForm").submit(function(){
				...
				if(checkUsername() && checkPassword() && checkEmail()){
					...
					$.post("${pageContext.request.contextPath}/user/user_save.do",$(this).serialize(),function(data){
						//处理服务器响应的数据  data  {flag:true,errorMsg:"注册失败"}

						if(data==="ok"){
							console.log("ok");
							//注册成功，跳转成功页面
							location.href="${pageContext.request.contextPath}/pages/user_register_ok.jsp";
						}else{
			...
			//当某一个组件失去焦点是，调用对应的校验方法 暂时关闭先 验证码也先不弄了
    	...
    	<div class="rg_layout">
    		<div class="rg_form clearfix">
    				...
    				<form id="registerForm">
    					...
    					<table style="margin-top: 25px;">
    						...
    						<tr>
    							...
    							<td class="td_right">
    								<input type="text" id="name" name="trueName" placeholder="请输入真实姓名">
    							</td>
    						</tr>
    						<tr>
    							<td class="td_left">
    			...
    			<div class="rg_form_right">
    				<p>
    					已有账号？
    					<a href="${pageContext.request.contextPath}/pages/user_login.jsp">立即登录</a>
    				</p>
    			</div>
    		</div>
    	</div>
