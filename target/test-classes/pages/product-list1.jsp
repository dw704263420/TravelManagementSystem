        ...
        <section class="content">
            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <a class="btn btn-default" title="新建" href='${pageContext.request.contextPath}/pages/product-add.jsp'><i class="fa fa-file-o"></i> 新建</a>
                            ...
                            <c:forEach items="${pageInfo.list}" var="product">
                                <tr id="product${product.id}">
                                    ...
                                    <td class="text-center">
                                        <a href="${pageContext.request.contextPath}/product/editProduct.do?id=${product.id}" class="btn bg-olive btn-xs">编辑</a>
                                        <a onclick="delById(${product.id})" class="btn bg-olive btn-xs" id="delById${product.id}">删除</a>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共${pageInfo.pages} 页， 每页 ${pageInfo.size}条
                        </div>
                    </div>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pages}&size=${pageInfo.pages}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    function delById(id){
        ...
        $.get({
            url:"${pageContext.request.contextPath}/product/delById",
            data:{
                id:id
            },
