...
<script src="https://cdn.bootcss.com/respond.js/1.4.2/respond.min.js"></script>
        ...
        <div class="shortcut">
            ...
            <div class="login" id="login" style="display: none;">
                ...
                <span id="span_username"></span>
                    ...
                    <a href="${pageContext.request.contextPath}/orders/MyOrder?uid=${uid}" class="collection">订单 </a>
    ...
    <div class="navitem">
        <ul class="nav" id="category">
            <li class="nav-active"><a href="${pageContext.request.contextPath}/forIndex">首页</a></li>
        </ul>
    </div>
<script>
    $(function () {
        ...
        $.get({
            ...
            success:function (data) {
                data= JSON.parse(data);
                // console.log(data);
                let lis = '<li class="nav-active"><a href="${pageContext.request.contextPath}/forIndex">首页</a></li>';
                // 遍历数组 拼合字符串
