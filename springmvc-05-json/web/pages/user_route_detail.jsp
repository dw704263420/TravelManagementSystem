            ...
            <div class="prosum_right">
               <p class="pros_title">${product.productName}</p>
                ...
                <div class="pros_price">
                    ...
                    <p  class="collect">
                        <a  href="${pageContext.request.contextPath}/product/buyProduct?productId=${product.id}&&uid=${uid}"  class="btn><i class="><i class="glyphicon glyphicon-shopping-cart"></i>立即购买</a>
                    </p>
                </div>        
            </div>
        </div>
