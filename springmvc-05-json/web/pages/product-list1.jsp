                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <a class="btn btn-default" title="新建" href='${pageContext.request.contextPath}/product/productAdd.do'><i class="fa fa-file-o"></i> 新建</a>
...
<script>
    ...
    function delById(id){
        ...
        $.get({
            ...
            error:function () {
                alert("删除失败！请确保该产品没有外键关联，或先将该产品相关订单删除！");
            }
        })
    }
