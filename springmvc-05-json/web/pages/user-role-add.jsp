...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
									...
									<c:forEach items="${roleList}" var="role">
										<tr id="role${role.id}">
											...
											<td class="text-center">
												<a onclick="addRoleById(${user.id},${role.id})" class="btn bg-olive btn-xs">添加此角色</a>
											</td>
										</tr>
									</c:forEach>
		...
		function addRoleById(userId,roleId) {
			var msg = "确认赋予该用户该角色。";
			if(confirm(msg)==true)
			{
				var  target = $("#role"+roleId);
				$.post({
					url:"${pageContext.request.contextPath}/user/relatedRole.do",
					data:{
						userId:userId,
						roleIds:roleId
					},
